<?php
/*
Plugin Name: Featured Image from Google Images
Plugin URI: http://wordpress.org/extend/plugins/featured-image-from-google-images/
Description: Fastest way to choose thumbnail for your posts.
Version: 1.0
Author: Ondřej Dadok
Author URI: http://www.ondrejdadok.cz/featured-image-from-google-images/
*/
...
function doAjaxRequest(val){
     ...
     jQuery.ajax({
          ...
          success:function(data){
             ...
             jQuery.getScript("/wp-content/plugins/featured-image-from-google-images/js.js", function(data, textStatus, jqxhr) {
         ...
         console.log('Load was performed.');
          ...
          error: function(errorThrown){
               alert('Gettin images from Google Images timeout. Please try again later.');
...
function myplugin_add_custom_box() {
    ...
    foreach ($screens as $screen) {
        add_meta_box(
            'myplugin_sectionid',
            __( 'Featured Image from Google Images', 'myplugin_textdomain' ),
